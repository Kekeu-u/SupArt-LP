        ...
        <div className="container mx-auto flex justify-between items-center">
          ...
          <nav>
            <ul className="flex gap-x-4">
              <li><a href="/" className="text-white hover:text-purple-400 transition-colors">Home</a></li>
              <li><a href="/blog" className={`text-white hover:text-purple-400 transition-colors ${pathname === '/blog' ? 'text-purple-400' : ''}`}>Blog</a></li>
            </ul>
          </nav>
        </div>
      </header>
