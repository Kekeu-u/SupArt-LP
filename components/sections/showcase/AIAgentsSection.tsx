            ...
            <div className="relative z-10 max-w-7xl mx-auto">
                ...
                <div className="grid md:grid-cols-2 gap-8 md:gap-12">
                    ...
                    >
                        ...
                        {/* Background Gradient */}
                        <div className="absolute inset-0 bg-gradient-to-br from-purple-900/20 via-transparent to-black opacity-50 group-hover:opacity-70 transition-opacity duration-500" />
                    </motion.div>
