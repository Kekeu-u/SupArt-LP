...
const BlogHeader: React.FC = () => {
    ...
    return (
        <header
            className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${isScrolled ? 'bg-white/80 dark:bg-black/80 backdrop-blur-md py-2' : 'bg-transparent py-4'}`}
        >
            <div className="container mx-auto px-6">
                <div className="flex items-center justify-between">
                    ...
                    >
                        ...
                        <span className="font-bold text-xl tracking-tight text-[var(--color-apple-black)] dark:text-white">
                            SupArt
                        </span>
                    </a>
                    ...
                    <nav className="flex items-center gap-4">
                        ...
                        <a
                            href="/blog"
                            className="text-sm font-medium text-gray-600 hover:text-black dark:text-gray-300 dark:hover:text-white transition-colors flex items-center gap-2"
                        >
