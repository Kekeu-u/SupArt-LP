    ...
    return (
        <article className="prose prose-lg prose-gray max-w-none">
            ...
            <header className="not-prose mb-10">
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-[1.1] bg-gradient-to-r from-gray-900 via-purple-900 to-gray-900 bg-clip-text text-transparent">
                    {post.title}
                </h1>
            ...
            <div className="not-prose mt-12 p-8 rounded-2xl bg-gradient-to-br from-purple-50/50 via-white/80 to-pink-50/50 backdrop-blur-sm border border-purple-500/20 flex gap-6 items-start relative overflow-hidden">
                ...
                <div className="relative flex-1">
                    ...
                    <div className="flex gap-3">
                        <a href="#" className="text-gray-400 hover:text-purple-600 transition-colors hover:scale-110 transform">
