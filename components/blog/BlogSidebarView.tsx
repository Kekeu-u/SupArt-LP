...
interface BlogSidebarViewProps {
    recentPosts: Post[];
    categories: Category[];
}

export const BlogSidebarView = ({ recentPosts, categories }: BlogSidebarViewProps) => {
        ...
        <aside className="space-y-6">
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <div className="flex items-center gap-2 mt-1.5">
                                    ...
                                    <span className="text-[10px] text-gray-400">
                                        {new Date(post.published_at).toLocaleDateString(locale === 'en' ? 'en-US' : 'pt-BR', { day: '2-digit', month: 'short' })}
                                    </span>
                                </div>
                            </div>
                        </Link>
            ...
            <div className="relative rounded-2xl border border-gray-200/50 bg-white/80 backdrop-blur-sm p-6 hover:bg-white/90 transition-all duration-300">
                ...
                <h3 className="relative text-lg font-bold bg-gradient-to-r from-gray-900 to-blue-900 bg-clip-text text-transparent mb-5">
                    {t("Explore Topics", "Explorar Tópicos")}
                </h3>
