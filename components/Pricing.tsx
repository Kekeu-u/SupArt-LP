  ...
  return (
    <section id="precos" className="py-12 sm:py-16 md:py-20 px-4 sm:px-6">
      <div className="container mx-auto max-w-4xl text-center">
        <h2 className="text-3xl sm:text-4xl font-bold mb-4 text-gray-900 dark:text-white text-pretty">Um Investimento Inteligente para o seu Negócio</h2>
        ...
        <div className="bg-white dark:bg-white/[.03] backdrop-blur-xl rounded-3xl p-8 md:p-12 border border-gray-200 dark:border-purple-500/50 shadow-2xl shadow-purple-400/10 dark:shadow-purple-400/20 transition-all duration-300 hover:border-purple-400/80 hover:-translate-y-2">
          <div className="md:flex justify-between items-center">
            <div className="text-left mb-8 md:mb-0">
              <h3 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white text-pretty">Landing Page de Alta Performance</h3>
            ...
            <div className="flex flex-col items-start md:items-end">
              <div className="text-left md:text-right">
                ...
                <p className="text-4xl sm:text-5xl font-extrabold text-gray-900 dark:text-white">R$1.890,00</p>
              </div>
          ...
          <div className="md:flex justify-between items-center text-gray-900 dark:text-white">
