  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center text-center px-6 pt-24">
      <div className="container mx-auto">
        <h1 className="hero-title text-4xl md:text-6xl lg:text-7xl font-extrabold text-white leading-loose mb-4">
        ...
        <p className="hero-subtitle text-lg md:text-xl text-gray-300 max-w-3xl mx-auto mb-8">
