...
const StepCard: React.FC<{ number: string; title: string; description: string }> = ({ number, title, description }) => (
    <div className="relative pl-12">
        <div className="absolute left-0 top-0 flex items-center justify-center w-12 h-12 rounded-full bg-violet-600 text-white font-bold text-xl border-4 border-slate-200 dark:border-slate-700">
           {number}
        </div>
        <div className="ml-4">
  ...
  return (
    <section id="processo" className="py-20 px-6">
      <div className="container mx-auto text-center">
        <h2 className="text-4xl font-bold mb-4">Nosso Processo é Simples e Transparente</h2>
        ...
        <div className="relative max-w-2xl mx-auto">
            {/* Connecting line */}
            <div className="hidden sm:block absolute top-6 left-6 w-1 h-full bg-slate-300 dark:bg-slate-700 -translate-x-1/2"></div>
